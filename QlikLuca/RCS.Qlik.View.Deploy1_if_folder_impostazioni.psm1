    ...
    {   #
        ...
        {   #
            ...
            {   #
                ...
                {   
                    #controlla se esistono la nuova cartella deployata nella destinazione
                    if (Test-Path -Path (Join-Path -Path $Destination -ChildPath $DataFolder.Name) )
                    {
                        ...
                        Write-Log -FileName $LogFileName -Message ( "- Deleted Old Folder : " + $DataFolder.Name )
                    }
                    else
                    {   
                        #se non esiste, notifica
                        Write-Log -FileName $LogFileName -Message ( "- No old " + $DataFolder.Name + " Folder found to Delete" )                       
                    } 
                    #copia tutta la cartella deployata nella destinazione                       
